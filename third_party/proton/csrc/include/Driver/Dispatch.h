...
#define DISPATCH_ARGS_N(_8, _7, _6, _5, _4, _3, _2, _1, _0, N, ...)            \
  DISPATCH_ARGS##N
#define DISPATCH_ARGS(...)                                                     \
  DISPATCH_ARGS_N(_0, ##__VA_ARGS__, _8, _7, _6, _5, _4, _3, _2, _1, _0)       \
  (__VA_ARGS__)
...
#define DISPATCH_VALS_N(_8, _7, _6, _5, _4, _3, _2, _1, _0, N, ...)            \
  DISPATCH_VALS##N
#define DISPATCH_VALS(...)                                                     \
  DISPATCH_VALS_N(_0, ##__VA_ARGS__, _8, _7, _6, _5, _4, _3, _2, _1, _0)       \
  (__VA_ARGS__)
